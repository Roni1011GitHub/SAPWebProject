...
namespace Controllers
{
    ...
    public class BaseController : Controller
    {
        ...
        //BCD
        //----------------
        public ActionResult BcdDetailPartial()
        {

            return PartialView("~/Views/_Bcd/DetailBcd.cshtml");
        }
        ...
        //PDF Param
        [HttpGet]
        public ActionResult DisplayPdfParam(string ReportFile, string ReportParam)
        {
            ReportDocument rptDoc;
            rptDoc = Models._Utils.Rpt.GetRptDoc(ReportFile, ReportParam);
            if (rptDoc != null)
            {
                Stream stream = rptDoc.ExportToStream(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat);
                rptDoc.Close();
        ...
        //EXCEL Param
        [HttpGet]
        public ActionResult DisplayExcelParam(string ReportFile, string ReportParam)
        {
            ReportDocument rptDoc;
            rptDoc = Models._Utils.Rpt.GetRptDoc(ReportFile, ReportParam);
            if (rptDoc != null)
        ...
        //Csv Param
        [HttpGet]
        public ActionResult DisplayCsvParam(string ReportFile, string ReportParam)
        {
            ReportDocument rptDoc;
            rptDoc = Models._Utils.Rpt.GetRptDoc(ReportFile, ReportParam);
            if (rptDoc != null)
        ...
        //Text Param
        [HttpGet]
        public ActionResult DisplayTextParam(string ReportFile, string ReportParam)
        {
            ReportDocument rptDoc;
            rptDoc = Models._Utils.Rpt.GetRptDoc(ReportFile, ReportParam);
            if (rptDoc != null)
        ...
        public ActionResult ViewJe_GetResult(string viewName)
        {
            ...
            var dtDim = PetaPoco.PetaPocoIduSqlRsExtensionsApp.IduGetDataTable(ssqlDataTable);
            ViewBag.DtDim = dtDim;
