...
namespace Controllers.Setting
{
    public partial class ReportController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<Tm_Report_View__> items = Report__List_Model.GetDataList(hidden_CpGvFind_FilterExpression, hidden_CpGvFind_SortExpression, Convert.ToInt32(hidden_CpGvFind_PageIndex), Convert.ToInt32(hidden_CpGvFind_PageSize));
