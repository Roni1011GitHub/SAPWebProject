...
namespace Controllers.Setting
{
    public partial class ApprovalController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<Tm_Approval_View__> items = Approval__List_Model.GetDataList(hidden_CpGvFind_FilterExpression, hidden_CpGvFind_SortExpression, Convert.ToInt32(hidden_CpGvFind_PageIndex), Convert.ToInt32(hidden_CpGvFind_PageSize));
