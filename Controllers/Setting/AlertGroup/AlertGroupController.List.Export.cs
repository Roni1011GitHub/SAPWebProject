...
namespace Controllers.Setting
{
    public partial class AlertGroupController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<Tm_AlertGroup_View__> items = AlertGroup__List_Model.GetDataList(hidden_CpGvFind_FilterExpression, hidden_CpGvFind_SortExpression, Convert.ToInt32(hidden_CpGvFind_PageIndex), Convert.ToInt32(hidden_CpGvFind_PageSize));
