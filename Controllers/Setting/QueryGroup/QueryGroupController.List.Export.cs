...
namespace Controllers.Setting
{
    public partial class QueryGroupController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<Tm_QueryGroup_View__> items = QueryGroup__List_Model.GetDataList(hidden_CpGvFind_FilterExpression, hidden_CpGvFind_SortExpression, Convert.ToInt32(hidden_CpGvFind_PageIndex), Convert.ToInt32(hidden_CpGvFind_PageSize));
