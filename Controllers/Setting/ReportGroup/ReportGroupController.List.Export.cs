...
namespace Controllers.Setting
{
    public partial class ReportGroupController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<Tm_ReportGroup_View__> items = ReportGroup__List_Model.GetDataList(hidden_CpGvFind_FilterExpression, hidden_CpGvFind_SortExpression, Convert.ToInt32(hidden_CpGvFind_PageIndex), Convert.ToInt32(hidden_CpGvFind_PageSize));
