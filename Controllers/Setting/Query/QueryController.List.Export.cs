...
namespace Controllers.Setting
{
    public partial class QueryController : BaseController
    {
        public ActionResult ExportTo()
        {
            ...
            List<Tm_Query_View__> items = Query__List_Model.GetDataList(hidden_CpGvFind_FilterExpression, hidden_CpGvFind_SortExpression, Convert.ToInt32(hidden_CpGvFind_PageIndex), Convert.ToInt32(hidden_CpGvFind_PageSize));
